google.maps.__gjsload__('search', function(_) {
    var Lta = function(a) {
        ...
        Kta = function(a) {
            ...
            const d = [];
            a.bv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new Mta(e, b, c))
            });
            return d
        },
        Nta = class extends _.ll {};
    var Ota = {
            ["1"]: {}
        },
        Mta = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Rm(new _.dn((this.rn.x * 256 + this.source.a[0]) / a, (this.rn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!Pta.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Xk(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Xk(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
                        ...
                        f.length && _.il(a, "addfeatures", f)
                    })()
                }
            }
        };
    dD.enableFeatureMapEventsRasterOnly = dD.enableFeatureMapEventsRasterOnly;
    _.Tl(dD.prototype, {
        map: _.Fq
    });
